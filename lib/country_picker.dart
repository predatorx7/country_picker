...
import 'package:country_picker/selection_dialog.dart';
...
class CountryPicker extends StatefulWidget {
  ...
  const CountryPicker({
    ...
    this.pickerMode = CountryPickerMode.dialingCodeOnly,
    this.favorite = const [],
    this.textStyle,
  ...
  @override
  State<StatefulWidget> createState() => CountryPickerState();
}
...
class CountryPickerState extends State<CountryPicker> {
  ...
  void initState() {
    super.initState();
    onConfigChange();
    assert(elements.isNotEmpty, 'Elements must not be empty');
  ...
  void onConfigChange() {
    final List<Map<String, String>> jsonList = widget.countryList;
